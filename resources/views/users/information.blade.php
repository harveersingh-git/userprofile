                                                    ...
                                                    <div class="card secondaryPanel">
                                                        ...
                                                        <div class="card-body well">
                                                            ...
                                                            <ul id="sortable" name="in_secondary_fields" class="sortable-list secondaryDropzone fixed-panel" data-fieldtype="secondary">
                                                                ...
                                                                <li class="sortable-item  allowSecondary allowExport" id="{{$skill->skills_details['id']}}">{{isset($res->skills_details['value'])?$res->skills_details['value']:''}} <i class="fa fa-close skill_delete" style="color:red;float: right;  cursor: pointer;"></i></li>
